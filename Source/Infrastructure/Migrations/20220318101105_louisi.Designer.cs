...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220318101105_louisi")]
    partial class louisi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.MessagingAggregate.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Aggregates.MessagingAggregate.MessageReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Infrastructure.Identity.Entities.AuthScheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Infrastructure.Identity.Entities.OpenIdOptions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Infrastructure.Identity.Entities.TeamAuthScheme", b =>
                {
                    b.Property<Guid>("AuthSchemeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("AuthSchemeId", "TeamId");

                    b.HasIndex("TeamId");

                    b.ToTable("TeamAuthScheme");
                });
            ...
            modelBuilder.Entity("Domain.Aggregates.MessagingAggregate.Message", b =>
                {
                    ...
                    b.HasOne("Domain.Aggregates.MessagingAggregate.Message", null)
            ...
            modelBuilder.Entity("Infrastructure.Identity.Entities.OpenIdOptions", b =>
                {
                    b.HasOne("Infrastructure.Identity.Entities.AuthScheme", "AuthScheme")
                        .WithOne("OpenIdOptions")
                        .HasForeignKey("Infrastructure.Identity.Entities.OpenIdOptions", "AuthSchemeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Infrastructure.Identity.Team", b =>
                {
                    ...
                    b.Navigation("SupportedAuthSchemes");
                });

...
namespace WebServer.Controllers.Stripe
{
    ...
    [ApiController]
    [AuthorizeTeamAdmin]
    public class StripeSessionController : AuthorizedBaseController
    {
        ...
        public async Task<ActionResult> RedirectToStripePremiumSubscription()
        {
            ...
            var checkoutSession = await stripeSessionService.CreateCheckoutSession(returnUrl, ApplicationUser, Tenant.Id, premiumSubscription);
        ...
        public async Task<ActionResult> RedirectToStripeEnterpriseSubscription()
        {
            ...
            var checkoutSession = await stripeSessionService.CreateCheckoutSession(returnUrl, ApplicationUser, Tenant.Id, enterpriseSubscription);
        ...
        {
            var billingPortalSession = await stripeSessionService.CreateBillingPortalSession(returnUrl, ApplicationUser.StripeCustomerId);
